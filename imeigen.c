...
int main(int argc, char **argv) {
    ...
    static char *routers[][7] =
    {
        ...
        {"^Moxee Tether[0-9]{2}(_2\\.4G|_5G)$",                      "8", "35199511", NULL},
        {"^T-Mobile Hotspot_[0-9]{4}_(2\\.4GHz|5GHz)$",              "8", "35200857", "86055005", NULL},
        ...
        {"^Moxee Hotspot[0-9]{2}(_2\\.4G|_5G)$",                     "8", "35890230", NULL},
        {"^Airtel-MW40-[0-9A-F]{4}$",                                "8", "35934707", NULL},
        ...
        {"^TP-Link_[0-9A-F]{4}$",                                    "8", "86019905", "86571203", NULL},
        {"^OptusWiFi E5331 [0-9a-f]{4}$",                            "8", "86066701", NULL},
        {"^inwi Home 4G [0-9A-F]{6}(_2\\.4G_EXT)?$",                 "8", "86074303", "86500906", "86658004", NULL},
        {"^BOX4G_Inwi_[0-9A-F]{4}$",                                 "8", "86092106", "86168405", NULL},
        {"^Andromax-M3Y-[0-9A-F]{4}$",                               "8", "86145803", NULL},
        {"^inwi Home 4G[0-9A-F]{6}$",                                "8", "86167204", "86846503", "86918004", NULL},
